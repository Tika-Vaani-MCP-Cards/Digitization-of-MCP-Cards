# This file will crop same roi's multiple times 
# w.r.t different local crops provided
# We can process all rois through the ocr and keep the one with 
# highest confidence
...
source = GLOBALLY_ALIGNED_IMAGES[template_name]
# read csv file of coordinates
template_coordinates = pd.read_csv(TEMPLATE_COORDINATES[template_name])

crop_coordinates_list = crop_coordinates_dict[template_name]
